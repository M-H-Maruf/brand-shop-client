...
const ErrorPage = () => {
  ...
  return (
    <div data-aos="fade-down" className=" bg-black/80 w-screen h-screen bg-[url('https://i.ibb.co/qWNH5fN/Alexandre-debieve-FO7-JIlwj-Ot-U-unsplash.jpg')] bg-cover bg-center bg-blend-darken text-white flex flex-col justify-center items-center pb-36 pt-28 tracking-normal text-justify">
