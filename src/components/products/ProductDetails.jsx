...
const ProductDetails = () => {
  ...
  useEffect(() => {
    fetch(`https://brand-shop-server-m9sqkj6uc-m-h-marufs-projects.vercel.app/product-details/${_id}`)
      .then((res) => res.json())
  ...
  const handleAddToCart = () => {
    ...
    fetch("https://brand-shop-server-m9sqkj6uc-m-h-marufs-projects.vercel.app/add-to-cart/", {
      method: "POST",
      headers: {
